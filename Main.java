public class Main {
    ...
    public static void main(String[] args) {
        ...
        State AZ = new State("Arizona", false, false, false, 46.7, 43.3, 11, WEST);
        ...
        State FL = new State("Florida", false, true, true, 48.2, 44.8, 29, SOUTH);
        State PA = new State("Pennsylvania", false, true, true, 48.3, 41.8, 20, NORTHEAST);
        State NC = new State("North Carolina", false, false, true, 45.5, 45.8, 15, SOUTH);
        State SC = new State("South Carolina", false, false, false, 44.0, 52.0, 9, SOUTH);
        State MN = new State("Minnesota", true, true, true, 46.9, 45.4, 10, MIDWEST);
        State WI = new State("Wisconsin", false, true, true, 46.7, 42.7, 10, MIDWEST);
        State MI = new State("Michigan", false, true, true, 50, 42.7, 16, MIDWEST);
        ...
        State MO = new State("Missouri", false, false, false, 43.5, 49.5, 10, MIDWEST);
        ...
        State AR = new State("Arkansas", false, false, false, 45.0, 47.0, 6, SOUTH);
